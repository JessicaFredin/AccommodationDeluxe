...
// 					<p className="text-lg font-bold mb-2">Tot: € 78</p>
// 					<Button
// 						size="medium"
// 						buttonText="Choose"
...
//           <div className="text-center">
//             <p className="text-lg font-bold mb-2">Tot: € 144</p>
//           </div>
//         </div>
//       )}
...
//       <div className="flex justify-between items-center mb-4">
//         <div className="flex flex-col items-start">
//           <h2 className="text-xl font-bold mb-4">Standard car – One way</h2>
...
//             <ul className="text-gray-700 text-sm space-y-2">
//               <li className="flex items-center">
//                 <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2" /> From: {transferData.fromLocation}
//               </li>
//               <li className="flex items-center">
//                 <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2" /> To: {transferData.toLocation}
//               </li>
//               <li className="flex items-center">
//                 <FontAwesomeIcon icon={faCalendarAlt} className="mr-2" /> {transferData.date}
//               </li>
//               <li className="flex items-center">
//                 <FontAwesomeIcon icon={faClock} className="mr-2" /> {transferData.time}
//               </li>
//             </ul>

//             <ul className="text-gray-700 text-sm space-y-2 ml-8">
//               <li className="flex items-center">
//                 <FontAwesomeIcon icon={faUserFriends} className="mr-2" /> {transferData.passengers} people
//               </li>
//               <li className="flex items-center">
...
//               </li>
//               <li className="flex items-center">
//                 <FontAwesomeIcon icon={faCheck} className="mr-2 text-green-500" /> Free cancellation
//               </li>
//             </ul>
//           </div>
//         </div>
...
//         <div className="flex justify-between items-center mb-4">
//           <div className="flex flex-col items-start">
//             <h2 className="text-xl font-bold mb-4">Standard car – Return</h2>
//             <img src={Car} alt="Car" className="w-[200px] h-auto rounded-lg" />
//           </div>
...
//               <ul className="text-gray-700 text-sm space-y-2">
//                 <li className="flex items-center">
//                   <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2" /> From: {transferData.returnTrip.fromLocation}
//                 </li>
//                 <li className="flex items-center">
//                   <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2" /> To: {transferData.returnTrip.toLocation}
//                 </li>
//                 <li className="flex items-center">
//                   <FontAwesomeIcon icon={faCalendarAlt} className="mr-2" /> {transferData.returnTrip.date}
//                 </li>
//                 <li className="flex items-center">
//                   <FontAwesomeIcon icon={faClock} className="mr-2" /> {transferData.returnTrip.time}
//                 </li>
//               </ul>

//               <ul className="text-gray-700 text-sm space-y-2 ml-8">
//                 <li className="flex items-center">
//                   <FontAwesomeIcon icon={faUserFriends} className="mr-2" /> {transferData.returnTrip.passengers} people
//                 </li>
//                 <li className="flex items-center">
//                   <FontAwesomeIcon icon={faSuitcaseRolling} className="mr-2" /> 5 suitcases
//                 </li>
...
//           <p className="text-lg font-bold mb-2">Tot: € 78</p>
//         )}
//         <Button size="medium" buttonText="Choose" onClick={handleNextStep} />
//       </div>
//     </div>
//   );
// }
    ...
    <div className="w-full max-w-[800px] bg-white rounded-lg p-6 shadow-md mx-auto mt-8">
      ...
      {showConfirmButton && currentStep >= 1 && (
        <div className="text-center mt-6">
          ...
          <Button size="large" buttonText="Confirm" onClick={handleConfirm} />
        </div>
      )}

      {showPopup && <AirportTransferConfirmation onClose={handleClosePopup} />}
    </div>
  );
}
