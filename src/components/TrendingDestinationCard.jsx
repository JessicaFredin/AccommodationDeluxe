	...
	return (
		...
		>
			...
			<div className="absolute bottom-0 left-0 w-full p-4 bg-opacityBlack flex justify-between items-center">
				...
				{/* Link component with state
				<Link
					to={{
						pathname: "/hotels", // Adjust the path if needed
						search: `?destinationId=${destinationId}&destination=${location}`, // Prefill the search query parameter
					}}
				>
